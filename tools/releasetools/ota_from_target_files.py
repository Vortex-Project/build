...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.vortex.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.vortex.device")

  script.Print("----------------------------------------------");
  script.Print("              Vortex OS Project");
  script.Print("                  by nextgen");
  script.Print("----------------------------------------------");
